...
INSERT INTO SCOTT.STUDENT(STD_KEY, STD_NAME) VALUES (1, 'A');
INSERT INTO SCOTT.STUDENT(STD_KEY, STD_NAME) VALUES (2, 'B');
INSERT INTO SCOTT.STUDENT(STD_KEY, STD_NAME) VALUES (3, 'C');
INSERT INTO SCOTT.STUDENT(STD_KEY, STD_NAME) VALUES (4, 'D');
-- END STUDENT TABLE
...
COMMENT ON COLUMN SCOTT.GRADE.GRD_SCORE IS '학생 성적';
...
INSERT INTO SCOTT.GRADE(GRD_KEY, GRD_NAME, GRD_SCORE, STD_KEY) VALUES (1, '영어', 10, 1);
INSERT INTO SCOTT.GRADE(GRD_KEY, GRD_NAME, GRD_SCORE, STD_KEY) VALUES (2, '영어', 20, 2);
INSERT INTO SCOTT.GRADE(GRD_KEY, GRD_NAME, GRD_SCORE, STD_KEY) VALUES (3, '영어', 40, 4);
-- END GRADE TABLE
...
(
    ...
    EXM_MAJOR VARCHAR2(30) NOT NULL,
    EXM_SCORE NUMBER       NOT NULL
) TABLESPACE DEV_DAT;
...
INSERT INTO SCOTT.EXAM(EXM_KEY, EXM_NAME, EXM_MAJOR, EXM_SCORE) VALUES(1, '홍길동', '수학', 99);
INSERT INTO SCOTT.EXAM(EXM_KEY, EXM_NAME, EXM_MAJOR, EXM_SCORE) VALUES(2, '홍길순', '수학', 95);
INSERT INTO SCOTT.EXAM(EXM_KEY, EXM_NAME, EXM_MAJOR, EXM_SCORE) VALUES(3, '고니', '영어', 33);
-- END EXAM TABLE
